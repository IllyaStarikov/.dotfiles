...
return {
  ...
  s("types", {
    ...
    t({"\"}), i(1, "UserID"), t({" = NewType('"}), f(function(args) return args[1][1] end, {1}), t({"', int)"}),
    t({"\"}), i(2, "ConfigDict"), t({": TypeAlias = Dict[str, Union[str, int, bool]]"}),
    t({"\"}), i(3, "DataList"), t({": TypeAlias = List["}), i(4, "Dict[str, Any]"), t({"]"}),
    t({""}),
    t({""}),
    t({"# Constants following Google style guide"}),
    t({"\"}), i(5, "DEFAULT_TIMEOUT"), t({": Final[int] = "}), i(6, "30"),
    t({"\"}), i(7, "MAX_RETRIES"), t({": Final[int] = "}), i(8, "3"),
    t({"\"}), i(9, "API_BASE_URL"), t({": Final[str] = '"}), i(10, "https://api.example.com"), t({"'"}),
    t({""}),
    t({""}),
