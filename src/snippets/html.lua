...
return {
  -- Complete HTML5 document skeleton
  s("skeleton", {
    t({"<!DOCTYPE html>"}),
    ...
    t({"    <meta name=\"keywords\" content=\""}), i(3, "keyword1, keyword2"), t({"\">"}),
    t({"    "}),
    t({"    <!-- Open Graph / Facebook -->"}),
    t({"    <meta property=\"og:type\" content=\"website\">"}),
    t({"    <meta property=\"og:title\" content=\""}), i(4, "Page Title"), t({"\">"}),
    t({"    <meta property=\"og:description\" content=\""}), f(function(args) return args[1][1] end, {2}), t({"\">"}),
    t({"    "}),
    t({"    <!-- Twitter -->"}),
    t({"    <meta name=\"twitter:card\" content=\"summary_large_image\">"}),
    t({"    <meta name=\"twitter:title\" content=\""}), f(function(args) return args[1][1] end, {4}), t({"\">"}),
    t({"    <meta name=\"twitter:description\" content=\""}), f(function(args) return args[1][1] end, {2}), t({"\">"}),
    t({"    "}),
    t({"    <title>"}), f(function(args) return args[1][1] end, {4}), t({"</title>"}),
    t({"    "}),
    t({"    <!-- Favicon -->"}),
    t({"    <link rel=\"icon\" type=\"image/x-icon\" href=\"/favicon.ico\">"}),
    t({"    "}),
    t({"    <!-- Stylesheets -->"}),
    t({"    <link rel=\"stylesheet\" href=\""}), i(5, "styles.css"), t({"\">"}),
    t({"</head>"}),
    t({"<body>"}),
    t({"    <header>"}),
    t({"        <nav aria-label=\"Main navigation\">"}),
    t({"            "}), i(6, "<!-- Navigation content -->"),
    t({"        </nav>"}),
    t({"    </header>"}),
    t({"    "}),
    t({"    <main>"}),
    t({"        "}), i(7, "<!-- Main content -->"),
    t({"        <h1>"}), f(function(args) return args[1][1] end, {4}), t({"</h1>"}),
    t({"        "}), i(8, "<!-- Page content -->"),
    t({"    </main>"}),
    t({"    "}),
    t({"    <footer>"}),
    t({"        "}), i(9, "<!-- Footer content -->"),
    t({"        <p>&copy; "}), f(function() return os.date("%Y") end, {}), t({" Illya Starikov. All rights reserved.</p>"}),
    t({"    </footer>"}),
    t({"    "}),
    t({"    <!-- Scripts -->"}),
    t({"    <script src=\""}), i(10, "script.js"), t({"\"></script>"}),
    t({"</body>"}),
    t({"</html>"}),
    i(0)
  }),
