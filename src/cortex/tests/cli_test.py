...
from cortex.cli import cli, download, list as list_command, model
...
class TestCLICommands(unittest.TestCase):
    ...
    def test_list_models_default(self, mock_cortex_class):
        ...
        mock_cortex.list_models.assert_called_once_with(
            provider=None, capability=None, local_only=False, recommended=False, format='table'
        )
    ...
    def test_list_models_with_filters(self, mock_cortex_class):
        ...
        mock_cortex.list_models.assert_called_with(
            provider='mlx', capability=None, local_only=False, recommended=False, format='table'
        )
        ...
        self.assertEqual(result.exit_code, 0)
        mock_cortex.list_models.assert_called_with(
            provider=None, capability=None, local_only=True, recommended=False, format='table'
        )
        ...
        self.assertEqual(result.exit_code, 0)
        mock_cortex.list_models.assert_called_with(
            provider=None, capability=None, local_only=False, recommended=True, format='table'
        )
    ...
    def test_list_models_with_capability_filter(self, mock_cortex_class):
        ...
        self.assertEqual(result.exit_code, 0)
        mock_cortex.list_models.assert_called_with(
            provider=None, capability='code', local_only=False, recommended=False, format='table'
        )
