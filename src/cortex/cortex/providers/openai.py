...
from . import BaseProvider, ModelInfo, ModelCapability, ProviderType
...
class OpenAIProvider(BaseProvider):
        ...
        if self.api_key:
            try:
                async with aiohttp.ClientSession() as session:
                    ...
                    async with session.get(f"{self.OPENAI_API}/models", headers=headers, timeout=5) as response:
                        if response.status == 200:
                            ...
                            for model_data in api_models:
                                ...
                                skip_patterns = ["whisper", "tts", "dall-e", "embedding", "moderation"]

                                # Check if we should include this model
                                should_include = any(pattern in model_id.lower() for pattern in include_patterns)
                                should_skip = any(pattern in model_id.lower() for pattern in skip_patterns)
    ...
    def _get_known_models(self) -> List[ModelInfo]:
        ...
        known_models = [
            ...
            {"id": "o1", "context": 200000, "output": 100000, "tier": "reasoning"},
            {"id": "o1-mini", "context": 128000, "output": 65536, "tier": "reasoning"},
            {"id": "o1-preview", "context": 128000, "output": 32768, "tier": "reasoning"},

            # GPT-4o models (multimodal)
            {"id": "gpt-4o", "context": 128000, "output": 16384, "tier": "flagship"},
            {"id": "gpt-4o-2024-11-20", "context": 128000, "output": 16384, "tier": "flagship"},
            {"id": "gpt-4o-2024-08-06", "context": 128000, "output": 16384, "tier": "flagship"},
            {"id": "gpt-4o-2024-05-13", "context": 128000, "output": 4096, "tier": "flagship"},
            {"id": "gpt-4o-mini", "context": 128000, "output": 16384, "tier": "efficient"},
            {"id": "gpt-4o-mini-2024-07-18", "context": 128000, "output": 16384, "tier": "efficient"},

            # GPT-4 Turbo models
            {"id": "gpt-4-turbo", "context": 128000, "output": 4096, "tier": "turbo"},
            {"id": "gpt-4-turbo-2024-04-09", "context": 128000, "output": 4096, "tier": "turbo"},
            {"id": "gpt-4-turbo-preview", "context": 128000, "output": 4096, "tier": "turbo"},
            {"id": "gpt-4-0125-preview", "context": 128000, "output": 4096, "tier": "turbo"},
            {"id": "gpt-4-1106-preview", "context": 128000, "output": 4096, "tier": "turbo"},

            # GPT-4 models
            {"id": "gpt-4", "context": 8192, "output": 8192, "tier": "standard"},
            {"id": "gpt-4-0613", "context": 8192, "output": 8192, "tier": "standard"},
            {"id": "gpt-4-32k", "context": 32768, "output": 8192, "tier": "standard"},
            {"id": "gpt-4-32k-0613", "context": 32768, "output": 8192, "tier": "standard"},

            # GPT-3.5 Turbo models
            {"id": "gpt-3.5-turbo", "context": 16385, "output": 4096, "tier": "fast"},
            {"id": "gpt-3.5-turbo-0125", "context": 16385, "output": 4096, "tier": "fast"},
            {"id": "gpt-3.5-turbo-1106", "context": 16385, "output": 4096, "tier": "fast"},
            {"id": "gpt-3.5-turbo-16k", "context": 16385, "output": 4096, "tier": "fast"},
        ]

        models = []
        for model_data in known_models:
            model_info = self._create_model_info(model_data["id"], {
    ...
    def _create_model_info(self, model_id: str, api_data: Dict[str, Any]) -> ModelInfo:
        ...
        context = 128000 if "gpt-4" in model_id.lower() else 16384 if "turbo" in model_id.lower() else 8192
    ...
    def _extract_capabilities_from_permissions(self, permissions: list, model_id: str) -> List[ModelCapability]:
