...
class GoogleProvider(BaseProvider):
    ...
    async def fetch_models(self, force_refresh: bool = False) -> List[ModelInfo]:
        ...
        known_models = [
            ...
            {"id": "gemini-2.0-flash-exp", "name": "Gemini 2.0 Flash Experimental", "context": 1048576, "output": 8192, "tier": "experimental"},
            {"id": "gemini-2.0-flash-thinking-exp", "name": "Gemini 2.0 Flash Thinking", "context": 32767, "output": 8192, "tier": "experimental"},

            # Gemini 1.5 Pro models
            {"id": "gemini-1.5-pro", "name": "Gemini 1.5 Pro", "context": 2097152, "output": 8192, "tier": "pro"},
            {"id": "gemini-1.5-pro-latest", "name": "Gemini 1.5 Pro Latest", "context": 2097152, "output": 8192, "tier": "pro"},
            {"id": "gemini-1.5-pro-002", "name": "Gemini 1.5 Pro 002", "context": 2097152, "output": 8192, "tier": "pro"},
            {"id": "gemini-1.5-pro-001", "name": "Gemini 1.5 Pro 001", "context": 2097152, "output": 8192, "tier": "pro"},

            # Gemini 1.5 Flash models
            {"id": "gemini-1.5-flash", "name": "Gemini 1.5 Flash", "context": 1048576, "output": 8192, "tier": "flash"},
            {"id": "gemini-1.5-flash-latest", "name": "Gemini 1.5 Flash Latest", "context": 1048576, "output": 8192, "tier": "flash"},
            {"id": "gemini-1.5-flash-002", "name": "Gemini 1.5 Flash 002", "context": 1048576, "output": 8192, "tier": "flash"},
            {"id": "gemini-1.5-flash-001", "name": "Gemini 1.5 Flash 001", "context": 1048576, "output": 8192, "tier": "flash"},
            {"id": "gemini-1.5-flash-8b", "name": "Gemini 1.5 Flash 8B", "context": 1048576, "output": 8192, "tier": "flash"},
            {"id": "gemini-1.5-flash-8b-latest", "name": "Gemini 1.5 Flash 8B Latest", "context": 1048576, "output": 8192, "tier": "flash"},

            # Gemini 1.0 Pro (Legacy)
            {"id": "gemini-1.0-pro", "name": "Gemini 1.0 Pro", "context": 32768, "output": 8192, "tier": "legacy"},
            {"id": "gemini-1.0-pro-latest", "name": "Gemini 1.0 Pro Latest", "context": 32768, "output": 8192, "tier": "legacy"},
            {"id": "gemini-1.0-pro-001", "name": "Gemini 1.0 Pro 001", "context": 32768, "output": 8192, "tier": "legacy"},

            # Gemini Pro Vision (Legacy)
            {"id": "gemini-pro-vision", "name": "Gemini Pro Vision", "context": 16384, "output": 2048, "tier": "legacy"},
        ]
        ...
        for known in known_models:
            if known["id"] not in existing_ids:
                metadata = self._infer_model_metadata(known["id"], {
                    "context": known["context"],
                    "output": known["output"],
    ...
    def _infer_model_metadata(self, model_id: str, model_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not metadata["description"]:
            if metadata.get("thinking"):
                ...
                metadata["description"] = f"Model with {metadata['context']//1000000}M token context"
