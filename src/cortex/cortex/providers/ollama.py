...
class OllamaProvider(BaseProvider):
    ...
    async def _get_model_details(self, session: aiohttp.ClientSession,
    ...
    def _extract_capabilities_from_api(self, details: Dict[str, Any],
                                       model_name: str) -> List[ModelCapability]:
        """Extract capabilities from API response."""
        capabilities = []
        ...
        if any(x in model_lower
               for x in ["code", "coder", "codellama", "deepseek-coder", "starcoder"]):
