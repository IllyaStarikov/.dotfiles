...
return {
  -- Basic document
  s("doc", {
    t({"\\documentclass{"}), c(1, {t("article"), t("report"), t("book"), t("beamer")}), t({"}", ""}),
    t({"", "\\begin{document}", ""}),
    i(2), t({"", ""}),
    t({"\\end{document}"}),
    i(0)
  ...
  s("fig", {
    ...
    t({"  \\centering", ""}),
    t({"  \\includegraphics[width="}), i(2, "0.8"), t({"\\textwidth]{"}), i(3, "image"), t({"}", ""}),
  ...
  s("table", {
    ...
    t({"  \\centering", ""}),
    t({"  \\begin{tabular}{"}), i(2, "c|c"), t({"}", ""}),
    t({"    "}), i(3, "Header1 & Header2 \\\\"), t({"", ""}),
    t({"    \\hline", ""}),
    t({"    "}), i(4, "Data1 & Data2 \\\\"), t({"", ""}),
    t({"  \\end{tabular}", ""}),
    t({"  \\caption{"}), i(5, "Caption"), t({"}", ""}),
    t({"  \\label{tab:"}), i(6, "label"), t({"}", ""}),
    t({"\\end{table}"}),
    i(0)
  }),
