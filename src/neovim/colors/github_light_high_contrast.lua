-- GitHub Light_High_Contrast colorscheme for Neovim
...
M.colors = {
  ...
  bright_red = "#86061d",
  bright_green = "#055d20",
  bright_yellow = "#4e2c00",
  bright_blue = "#1168e3",
  bright_magenta = "#844ae7",
  bright_cyan = "#3192aa",
  bright_white = "#88929d",
}
...
function M.setup()
  ...
  vim.g.colors_name = "github_light_high_contrast"
  ...
  local highlights = {
    ...
    TabLineSel = { fg = c.accent, bg = c.surface, bold = true },
    ...
    BufferLineDuplicate = { fg = c.muted, bg = c.surface, italic = true },
    BufferLineDuplicateSelected = { fg = c.muted, bg = c.bg, italic = true },
    BufferLineDuplicateVisible = { fg = c.muted, bg = c.surface, italic = true },
    ...
    BufferLineNumbers = { fg = c.muted, bg = c.surface },
    BufferLineNumbersSelected = { fg = c.fg, bg = c.bg },
    BufferLineNumbersVisible = { fg = c.muted, bg = c.surface },
