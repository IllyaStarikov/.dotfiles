...
local function setup_ai_commands()
  ...
  api.nvim_create_user_command("AIInfo", function()
    ...
    table.insert(info, "  <leader>a1  - Small model")
    table.insert(info, "  <leader>a2  - Medium model")
    table.insert(info, "  <leader>a3  - Large model")
    table.insert(info, "  <leader>a?  - List models")
    table.insert(info, "  <leader>ac  - Open chat")
    table.insert(info, "  <leader>aa  - Actions palette (visual mode)")
